...
<body>
	<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Error al colocar la de agua en el PDF</h1>
          </div>
    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <p>
            El PDF que intentó visualizar se encuentra encriptado o protegido con contraseña, por lo que no se puede colocar la marca de agua.
            <br>Informe el problema al usuario que subió contrato para que lo vuelva a colgar desencriptado, o para que desactive la opción de "visualizar con marca de agua".
          </p>
